# RailsAdmin config file. Generated on October 04, 2013 13:50
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Mejorandola', 'Admin']
  ...
  config.excluded_models = ['MejorandolaApi', 'Helpers::ApiHelpers','MejorandolaAPI::Courses', 'MejorandolaAPI::Status', 'V1::Courses', 'V1::Status', 'V1::V1']
  ...
  #     configure :thumb_url, :text 
  #     configure :start_at, :date 
  #     configure :ends_at, :date 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
